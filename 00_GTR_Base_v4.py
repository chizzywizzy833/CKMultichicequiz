...
def instructions():
    ...
    print()
    print("""
    You will be given a list of ingredients for a certain dish. From
    the ingredients list, there will be four recipes to choose from.
    It is up to you to guess from the ingredients what the recipe is.
    If you get it correct, you get a point. If not, you will be asked 
    the next question. Don't worry if your fingers slip and you press 
    the wrong key. You'll be given another opportunity to answer the 
    question again.
    """)
    print()
    return ""
